...
tf.app.flags.DEFINE_string('test_files', '120', """Files for testing have this name""")
...
tf.app.flags.DEFINE_string('RunInfo', 'Val3_128/', """Unique file name for this training run""")
